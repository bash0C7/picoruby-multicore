MRuby::Gem::Specification.new('picoruby-multicore') do |spec|
  ...
  # CMake source list on rp2040). The kernel table
  # (`multicore_kernels`) must come from the build that owns the kernels
  # (sendairk03's picoruby-kernel_registry); the gem has no default.
  #
